...
while(epoch < NUMBER_EPOCHS and abs(e_valid1) > 0 and 1):
    ...
    for m in input_range:
        ...
        net1 += wb1
        ########### Activation
        o1 = matrix_function(net1, logsig)
        diff_o1 = matrix_function(net1, diff_logsig)
        net2 = w2.dot(o1) + wb2
        o2 = net2[0,0]
        e = d_learn[m , 0] - o2
